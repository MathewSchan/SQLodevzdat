...
3.  cesta vedla skrze zjištění sestavení databáze po zjištění jmen tabulek a následném použití comandu ' UNION SELECT 1, sql FROM sqlite_master WHERE type='table' AND name='config'-- díky čemu mi databáze vypsala zbytek toho, co jsem potřeboval abych mohl použít payload

4. vlajka: FLAG{Sql_Un1on_M4st3r_S0SE}
